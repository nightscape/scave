...
public class DiscreteFourierTransformTest extends JUnitTests {
  ...
  /**
   * Test method for
   * {@link cs.jwave.handlers.DiscreteFourierTransform#forward(double[])}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link cs.jwave.handlers.DiscreteFourierTransform#reverse(double[])}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link cs.jwave.handlers.DiscreteFourierTransform#forward(cs.jwave.types.Complex[])}
   * .
   */
  @Test
  ...
  /**
   * Test method for
   * {@link cs.jwave.handlers.DiscreteFourierTransform#reverse(cs.jwave.types.Complex[])}
   * .
   */
  @Test
