...
public class Lege02 extends Wavelet {
  ...
  /**
   * The forward wavelet transform using the Legendre wavelet of 2 coefficients.
   * The arrTime array keeping coefficients of time domain should be of length 2
  ...
  /**
   * The reverse wavelet transform using the Legendre wavelet of 2 coefficients.
   * The arrHilb array keeping coefficients of Hilbert domain should be of
