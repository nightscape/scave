...
public class BlockIndex extends Block {
   ...
   * @date 12.06.2011 23:45:37
   * @author Christian Scheiblich
   * @see math.jwave.superblocks.blocks.Block#Block(int, int, int, int)
   */
   ...
   * @date 12.06.2011 23:45:37
   * @author Christian Scheiblich
   * @see math.jwave.superblocks.blocks.Block#get(int, int)
   */
  @Override
   ...
   * @date 12.06.2011 23:45:37
   * @author Christian Scheiblich
   * @see math.jwave.superblocks.blocks.Block#get()
   */
  @Override
   ...
   * @date 12.06.2011 23:45:37
   * @author Christian Scheiblich
   * @see math.jwave.superblocks.blocks.Block#set(int, int, double)
   */
  @Override
   ...
   * @date 12.06.2011 23:45:37
   * @author Christian Scheiblich
   * @see math.jwave.superblocks.blocks.Block#allocateMemory()
   */
  @Override
   ...
   * @date 12.06.2011 23:45:37
   * @author Christian Scheiblich
   * @see math.jwave.superblocks.blocks.Block#eraseMemory()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see math.jwave.superblocks.blocks.Block#computeMemory()
   */
  @Override
