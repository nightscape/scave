 ...
 *
 * This file SuperBlockError.java is part of JWave.
 *
 ...
 * @author Christian Scheiblich
 */
public class SuperBlockError extends SuperBlockException {
   ...
   * @param message
   */
  public SuperBlockError( String message ) {
    super( message );
  }
   ...
   */
  public SuperBlockError( Exception e ) {
    super( e );
  }
